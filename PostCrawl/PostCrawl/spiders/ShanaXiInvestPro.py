...
class ShanaxiinvestproSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.shanxitzxm.gov.cn/tzxmweb/pages/home/approvalResult/acceptancePublicityInfo.jsp',
    ...
    def parse(self, response, **kwargs):
        ...
        for id1, id2, id3, id4, title_name, title_date in zip(id1_list, id2_list, id3_list, id4_list, title_name_list,
            ...
            item['title_url'] = f"http://www.shanxitzxm.gov.cn/tzxmweb/pages/home/approvalResult/acceptancePublicityDetail.jsp?publicity_id={id1}&projectuuid={id2}&item_id={id3}&sendid={id4}&publicity_type=1"
...
if __name__ == '__main__':
    ...
    os.system("scrapy crawl ShanaXiInvestPro")
